...
import { fetchCourseCategories, addCourseDetails, editCourseDetails, createSection, updateSection, deleteSection, createSubSection, updateSubSection, deleteSubSection } from "../services/operations/courseDetailsAPI";
...
function CourseInfoStep() {
  ...
  useEffect(() => {
    ...
    if (editCourse && course) {
      ...
      setThumbnailUri(course.thumbnail || null);
      if (course.category) {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      // Append file if it's a local URI (starts with file://)
