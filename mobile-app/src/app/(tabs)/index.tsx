  ...
  return (
    <SafeAreaView className="flex-1 bg-richblack-900">
      <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false}>
        {/* Header bar */}
        <View className="flex-row justify-between items-center py-4 border-b border-richblack-800">
          <View className="flex-row items-center space-x-2">
            <Ionicons name="school" size={26} color="#FFD60A" />
            <Text className="text-xl font-bold text-richblack-5 ml-1">StudyNotion</Text>
          </View>
        ...
        {/* Hero Card */}
        <View className="bg-richblack-800 rounded-2xl p-6 mt-6 border border-richblack-700">
          <Text className="text-2xl font-extrabold text-richblack-5 leading-tight">
            Empower Your Future with <Text className="text-yellow-50 font-extrabold">Coding Skills</Text>
          </Text>
          <Text className="text-sm text-richblack-100 mt-2 mb-4 leading-relaxed">
        ...
        <View className="mt-8 mb-8">
          <Text className="text-lg font-bold text-richblack-5 mb-4">Recommended Courses</Text>
          {courses.length === 0 ? (
            ...
            <View className="space-y-4">
              {courses.map((item, idx) => (
                ...
                >
                  ...
                  />
                  <View className="p-4">
                    <Text className="text-base font-bold text-richblack-5">{item.courseName}</Text>
                    <Text className="text-xs text-richblack-300 mt-1" numberOfLines={2}>
                      {item.courseDescription}
                    </Text>
                    <View className="flex-row justify-between items-center mt-3 pt-3 border-t border-richblack-700">
