    ...
    <SafeAreaView className="flex-1 bg-richblack-900">
      ...
      <View className="px-4 py-3 border-b border-richblack-800 flex-row justify-between items-center">
        <View className="flex-row items-center">
          ...
          <Text className="text-xl font-bold text-richblack-5">All Instructors</Text>
        </View>
        <TouchableOpacity
              ...
              >
                <View className="flex-row items-center flex-1 mr-3">
                  ...
                  <View className="ml-3 flex-shrink-1">
                    ...
                    <Text className="text-xs text-richblack-300 mt-0.5">{instructor.email}</Text>
                    {instructor.contactNumber ? (
                      <Text className="text-xxs text-richblack-400 mt-0.5">{instructor.contactNumber}</Text>
                    ) : null}
                  </View>
                </View>
        ...
        <View className="flex-1 bg-black/80 justify-end">
          <View className="bg-richblack-800 border-t border-richblack-700 rounded-t-2xl p-5 max-h-[90%]">
            <View className="flex-row justify-between items-center pb-4 border-b border-richblack-700">
              <Text className="text-lg font-bold text-richblack-5">Create Instructor Account</Text>
