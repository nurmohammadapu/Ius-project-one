...
//             >
//               <div
//                 className="flex flex-col sm:flex-row w-full sm:w-[45%] cursor-pointer items-center gap-4 px-5 py-3"
//                 onClick={() => {
//                   navigate(
...
//                 />
//                 <div className="flex w-full sm:max-w-xs  flex-col gap-2">
...
//               <div className=" w-full sm:w-1/4 px-5 sm:px-2 py-3">{course?.totalDuration}</div>
//               <div className="flex w-full sm:w-1/5 flex-col gap-2 px-5 sm:px-2 py-3">
        ...
        <div className="my-8 text-richblack-5">
          ...
          {enrolledCourses.map((course, i, arr) => (
            ...
            >
              ...
              <div className="w-full md:w-1/4 px-5 md:px-2 py-3">{course?.totalDuration}</div>
              <div className="flex w-full md:w-1/5 flex-col gap-2 px-5 md:px-2 py-3">
                <p>Progress: {course.progressPercentage || 0}%</p>
                <ProgressBar
                  completed={course.progressPercentage || 0}
                  height="8px"
